#ifndef NERD_BASE_MERSENNETWISTERRANDOM_HPP
#define NERD_BASE_MERSENNETWISTERRANDOM_HPP
...
namespace base {
	...
	class NERD_BASE_API MersenneTwisterRandom : public Random {
...
#endif /* NERD_BASE_MERSENNETWISTERRANDOM_HPP */
