#ifndef NERD_BASE_FLOATLAYOUT_HPP
#define NERD_BASE_FLOATLAYOUT_HPP
...
namespace base {
	...
	template<std::size_t AllocationSize>
	class FloatLayout;

	// half precision (binary16)
	template<>
	class FloatLayout<static_cast<std::size_t>(2u)> {
	...
	template<>
	class FloatLayout<static_cast<std::size_t>(4u)> {
	...
	template<>
	class FloatLayout<static_cast<std::size_t>(8u)> {
	...
	template<>
	class FloatLayout<static_cast<std::size_t>(16u)> {
	...
	template<>
	class FloatLayout<static_cast<std::size_t>(12u)> {
	...
	#define NERD_FLOATTRAITS_IMPL(type, frexp, ldexp, modf) \
		template<> \
	...
	NERD_FLOATTRAITS_IMPL(float, frexpf, ldexpf, modff)
	NERD_FLOATTRAITS_IMPL(double, frexp, ldexp, modf)
	...
	//NERD_FLOATTRAITS_IMPL(long double, frexpl, ldexpl, modfl)

	#undef NERD_FLOATTRAITS_IMPL

}}

#endif /* NERD_BASE_FLOATLAYOUT_HPP */
